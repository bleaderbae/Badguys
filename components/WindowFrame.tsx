...
export default function WindowFrame({ children, title = "Application" }: WindowFrameProps) {
  return (
    <div className="w-full md:max-w-6xl h-full md:h-[85vh] bg-gray-900 border-0 md:border-2 border-gray-600 shadow-2xl md:rounded-lg overflow-hidden flex flex-col md:animate-scale-in relative z-50">
      {/* Title Bar */}
