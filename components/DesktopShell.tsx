    ...
    <div className="min-h-screen bg-black font-sans isolate overflow-hidden grid grid-cols-[1fr] grid-rows-[1fr]">
      ...
      >
        <button 
          ...
          className={`
            px-4 py-1 flex items-center gap-2 border-2 shadow-sm active:shadow-inner active:border-gray-900 transition-all focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:bg-white/10 focus:outline-none active:scale-95
        ...
        <div className="flex-1 mx-4 flex items-center gap-2 overflow-x-auto">
            {!isHome && (
                <button
                    ...
                    aria-label={isMinimized ? `Restore ${windowTitle}` : `Minimize ${windowTitle}`}
                    className={`
                        px-4 py-1 flex items-center gap-2 border-2 shadow-sm transition-all min-w-[150px] max-w-[200px] truncate focus-visible:ring-2 focus-visible:ring-green-400 focus-visible:bg-white/10 focus:outline-none active:scale-95
                        ${!isMinimized
